    ...
    companion object {
        val makeupList = listOf(
            ...
            Makeup(
                ...
                description = "Make Over Powerstay Glazed Lock Lip Pigment merupakan level terbaru dari lip gloss, memberikan hasil bibir plump dan glazy yang uncrackable (tampilan tahan lama tanpa cracking) hingga 24 jam. Plump Glaze menghasilkan tampilan bibir halus bahkan ketika digunakan di bibir kering, glossy, dan pigmented hanya dalam 1 olesan, bahkan ketika digunakan di bibir gelap. Diformulasikan dengan paten POWERGLAZE TECHNOLOGY™, intensitas pigmen produk ini dapat tahan sepanjang hari tanpa retak, tahan transfer, dan tahan noda.",
                year = "2024"
            ),
            Makeup(
                id = "3",
                ...
                description = "Make Over Lash Impulse Waterproof Mascara 9 ml adalah maskara tahan air dengan 3D Maxi-Lash Technology yang menghasilkan volume 10x* pada bulu mata anda menjadikannya lebih tebal, lentik, dan lebat. Maskara ini diformulasikan dengan formula zero-smudge yang menjaga kinerja maskara ini tidak luntur hingga 12 jam. Diinovasikan dengan customized dual sided flat-curve brush yang secara presisi didesain untuk memberikan hasil maksimal tanpa menggumpal.",
                year = "2022"
            ),
            Makeup(
                id = "4",
                ...
                description = "Semarakkan penampilan Anda dengan blusher stick transformasi unik ini. Dengan Powder Shifter Technology, tekstur krimnya langsung berubah menjadi bedak lembut yang meleleh di kulit. Teksturnya yang lembut dan creamy membuat blush ini menyatu sempurna di kulit, namun hasil akhir bedak lembut memberikan tampilan matte yang menggoda dan aplikasi yang ringan. Dilengkapi formula Hi-Impact Pigmented dan Color Diffused Tone Up yang memberikan rona alami yang intens namun halus yang menghadirkan kesan modern pada wajah yang lebih cerah.",
                year = "2023"
            ),
            Makeup(
                id = "5",
                ...
                description = "Pena eye liner warna intens dengan aplikator ujung kuas yang lembut, tipis, dan fleksibel untuk aplikasi yang tepat guna menciptakan tampilan berani dan kuat yang tahan lama.",
                year = "2023"
            ),
            Makeup(
                id = "6",
            ...
            Makeup(
                ...
                description = "Melembabkan dan mempersiapkan kulit untuk riasan, rahasia riasan tahan lama para penata rias profesional. Mengandung: - Aloe Vera sebagai agen penenang, pelembab dan anti iritasi - Pro Vitamin B5 sebagai pelembab - Vitamin E sebagai antioksidan",
                year = "2022"
            )
        )
    }
